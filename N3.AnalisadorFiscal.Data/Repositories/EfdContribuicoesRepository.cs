...
public sealed class EfdContribuicoesRepository : RepositoryBase, IEfdContribuicoesRepository
{
        ...
        CancellationToken cancellationToken = default)
    {
        ...
        return r.Codigo switch
        {
            ...
            "C175" => InsertAsync("""
                INSERT INTO EFD_CONTRIB_C175 (ID_CONTRIB_C100,CFOP,VL_OPR,VL_DESC,CST_PIS,VL_BC_PIS,ALIQ_PIS,QUANT_BC_PIS,ALIQ_PIS_QUANT,VL_PIS,CST_COFINS,VL_BC_COFINS,ALIQ_COFINS,QUANT_BC_COFINS,ALIQ_COFINS_QUANT,VL_COFINS,COD_CTA,INFO_COMPL)
                OUTPUT INSERTED.ID_CONTRIB_C175 VALUES (@PaiId,@P2,@N3,@N4,@P5,@N6,@N7,@N8,@N9,@N10,@P11,@N12,@N13,@N14,@N15,@N16,@P17,@P18);
